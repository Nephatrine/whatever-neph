...
function(we_package)
	...
	# Avoid MinGW vs MSVC Confusion
	if(MINGW)
		set(OS_TOKEN "MinGW")
	else()
		set(OS_TOKEN ${CMAKE_SYSTEM_NAME})
	endif()
	...
	string(TOLOWER "${CPACK_PACKAGE_NAME}-${CPACK_PACKAGE_VERSION}-${OS_TOKEN}.${WHATEVER_SYSTEM_ARCH}" CPACK_PACKAGE_FILE_NAME)
